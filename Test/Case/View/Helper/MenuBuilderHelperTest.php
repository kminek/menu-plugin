...
class MenuBuilderHelperTest extends CakeTestCase {
	...
	function testBuildDefault() {
		...
		$expected = array(
			...
			array('a' => array('href' => '/item-1', 'title' => 'Item 1')),
			'Item 1',
			'</a',
			'</li',
			'<li',
			array('a' => array('href' => '/item-2', 'title' => 'Item 2')),
			'Item 2',
			'</a',
			'</li',
			'</ul'
	...
	function testWithLink() {
		...
		$expected = array(
			...
			'<ul',
			array('li' => array('class' => 'first-item')),
			array('a' => array('href' => '/item-1.1', 'title' => 'Item 1.1')),
			'Item 1.1',
			'</a',
			'</li',
			'<li',
			array('a' => array('href' => '/item-1.2', 'title' => 'Item 1.2')),
			'Item 1.2',
			'</a',
			'</li',
			'</ul',
		...
		$expected = array(
			...
			'<ul',
			array('li' => array('class' => 'first-item')),
			array('a' => array('href' => '/item-2.1', 'title' => 'Item 2.1')),
			'Item 2.1',
			'</a',
			'</li',
			'<li',
			array('a' => array('href' => '/item-2.2', 'title' => 'Item 2.2')),
			'Item 2.2',
			'</a',
			'</li',
			'</ul',
		...
		$expected = array(
			...
			'<ul',
			array('li' => array('class' => 'first-item')),
			array('a' => array('href' => '/item-1.2.1', 'title' => 'Item 1.2.1')),
			'Item 1.2.1',
			'</a',
			'</li',
			'<li',
			array('a' => array('href' => '/item-1.2.2', 'title' => 'Item 1.2.2')),
			'Item 1.2.2',
			'</a',
			'</li',
			'</ul',
	...
	function testActiveClass() {
		...
		$expected = array(
			'<ul',
			array('li' => array('class' => 'first-item active')),
			array('a' => array('href' => '/item-1', 'title' => 'Item 1')),
			'Item 1',
			'</a',
			'</li',
	...
	function testId() {
		...
		$expected = array(
			'<ul',
			array('li' => array('id' => 'item-1', 'class' => 'first-item')),
			array('a' => array('href' => '/item-1', 'title' => 'Item 1')),
			'Item 1',
			'</a',
			'</li',
		...
		$expected = array(
			...
			'</a',
			'<ul',
			array('li' => array('id' => 'item-2.1', 'class' => 'first-item')),
			array('a' => array('href' => '/item-2.1', 'title' => 'Item 2.1')),
			'Item 2.1',
			'</a',
			'</li',
	...
	function testClass() {
		...
		$expected = array(
			...
			'</a',
			'<ul',
			array('li' => array('class' => 'first-item three')),
			array('a' => array('href' => '/item-1.1', 'title' => 'Item 1.1')),
			'Item 1.1',
			'</a',
			'</li',
			...
			'</a',
			'<ul',
			array('li' => array('class' => 'first-item five six seven')),
			array('a' => array('href' => '/item-2.1', 'title' => 'Item 2.1')),
			'Item 2.1',
			'</a',
			'</li',
